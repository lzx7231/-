...
export const Loading = {
  template: `
    <div class="loading-panel" v-if="$attrs.status">
      <link rel="stylesheet" href="${SYS_NAME}/lib/resource/loading/loading.css">
      <template v-if="$attrs.mode === 1">
      ...
      <template v-if="$attrs.mode === 2">
        <div class="loader loader-2">
          <svg class="loader-star" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
            <polygon points="29.8 0.3 22.8 21.8 0 21.8 18.5 35.2 11.5 56.7 29.8 43.4 48.2 56.7 41.2 35.1 59.6 21.8 36.8 21.8 "
              fill="#18ffff" />
          </svg>
      ...
      <template v-if="$attrs.mode === 7">
        <div class="loader loader-4"></div>
      </template>
      
      <template v-if="$attrs.mode === 8">
      ...
      <template v-if="$attrs.mode === 9">
        <div class="loader loader-12">
          <svg class="loader-star star1" version="1.1" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="35px" height="35px" viewBox="0 0 23.172 23.346"
            xml:space="preserve">
            <polygon
      ...
      <template v-if="$attrs.mode === 10">
        <div class="loader loader-6">
          <div class="loader-inner"></div>
        </div>
      </template>
      
      <template v-if="$attrs.mode === 11">
      ...
      <template v-if="$attrs.mode === 14">
        <div class="loader loader-20">
          <div class="css-diamond"></div>
        </div>
      </template>
      
      <template v-if="$attrs.mode === 15">
